...
if __name__ == '__main__':
    get_data_list(r'G:\dataset\UrbanSound8K\audio', 'dataset')
    # 生成生成方言数据列表
    # get_language_identification_data_list(audio_path='dataset/language', list_path='dataset/')
    # 创建UrbanSound8K数据列表
    create_UrbanSound8K_list(audio_path=r'G:\dataset\UrbanSound8K\audio',
                             metadata_path=r'G:\dataset\UrbanSound8K\metadata\UrbanSound8K.csv',
                             list_path='dataset')
